...
from apps.sprint_analyzer.data_analyzer import DataAnalyzer
from apps.sprint_analyzer.sprint_retriever import SimpleSprintRetriever
...
class SprintAnalyzer:
    ...
    def __init__(self, jira_client: JiraClient):
        ...
        self.completion_statuses = ['Done', 'Closed','PRD Deployed','Resolved','Cancelled','Abandoned']
