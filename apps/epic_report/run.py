"""
Standalone launcher for Epic Report application.

Usage:
    python run.py                    # Start on default port 5002
...
def create_app():
    """Create standalone Flask app and register epic report blueprint."""
    app = Flask(__name__)
...
def main():
    """Run epic report as standalone app."""
    parser = argparse.ArgumentParser(description='Epic Report Launcher')
